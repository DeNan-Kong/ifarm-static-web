                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="radio" name="maritalStatus" value="0" checked=""
                                                   style="display:none">
                                            <input type="radio" name="maritalStatus" class="jdradio" value="1"><label
                                                class="mr10">未婚</label>
                                            <input type="radio" name="maritalStatus" class="jdradio" value="2"><label
                                                class="mr10">已婚</label>
                                            <input type="radio" name="maritalStatus" class="jdradio" value="3"><label
                                                class="mr10">保密</label>
                                        </div>
                                    </div>
                                    <div class="item">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            ...
                                            <div id="cidInputDIv" style="display:none">
                                                <input name="userVo.cid" id="cid" value="140109198709195835"
                                                       maxlength="18" type="text" class="itxt">
                                                <div class="clr"></div>
