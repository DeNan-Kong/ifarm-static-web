                                        ...
                                        <td>
                                            <ul class="pro-info" oid="3122336930" pid="975788">
                                                        ...
                                                        <div class="p-img fl">
                                                            <a target="_blank" href="http://item.jd.com/975788.html">
                                                                <img width="50" height="50"
                                                                     title="佳能（Canon） MG2400 超值彩色喷墨一体机（打印 复印 扫描）"
                                                                     data-img="1"
                                                                     src="/images/rBEhV1I2yiUIAAAAAADKL7RWKf8AADQDQOQekkAAMpH341.jpg"
                                                                     class="err-product">
                                                            </a>
                                                        </div>
                                                        <div class="p-name fl">
                                                            <a target="_blank" href="http://item.jd.com/975788.html">佳能（Canon）
                                                                MG2400 超值彩色喷墨一体机（打印 复印 扫描）</a>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="fore2">
                                                ...
                                                <li class="fore3 forem">
                                                    <a href="#none" voucherstatus="0" class="pj" alt="975788"
                                                       title="发评价拿京豆" catefirst="670" catesecond="716" catethird="720">发表评价<b
                                                            class="icon-show"></b></a>
                                                </li>
                                            </ul>
                                            <div class="clr"></div>
                                            <div class="comment-box prompt01" oid="3122336930" pid="975788"
                                                 style="display: block;">
                                                <div class="box-t"></div>
                                                <div class="form" tagflag="true" isconspros="0" pid="975788">
                                                    ...
                                                    <div class="item tagEl" style="">
                                                        ...
                                                        <div class="fl">
                                                            <ul class="tips-list">
                                                                <li vid="132"><s class="f-check"></s>复印速度快</li>
                                                                <li vid="128"><s class="f-check"></s>复印也不错</li>
                                                                <li vid="131"><s class="f-check"></s>耗材便宜</li>
                                                                <li vid="135"><s class="f-check"></s>使用方便</li>
                                                                <li vid="136"><s class="f-check"></s>扫描方便</li>
                                                                <li vid="134"><s class="f-check"></s>效果不错</li>
                                                                <li vid="133"><s class="f-check"></s>功能齐全</li>
                                                                <li vid="129"><s class="f-check"></s>机器不错</li>
                                                                <li vid="137"><s class="f-check"></s>墨盒便宜</li>
                                                                <li class="list-last">
                                                    ...
                                                    <div class="item imgEl" id="imgContainer_3122336930_975788"
                                                            ...
                                                            <div class="upload-img-box">
                                                                <div class="img-list">
                                                                    ...
                                                                    <ul class="img-list-ul">
                                                                        <li class="upload-btn">
                                                                            <div>
                                                                                <a id="pickbutton_3122336930_975788"
                                                                                   href="#none"
                                                                                   style="position: relative; z-index: 1;">添加图片</a>
                                                        ...
                                                        <div id="p19acd7g5qnca3pgaq413318ug5_html5_container"
                                                             class="plupload html5"
                                                             style="position: absolute; width: 82px; height: 82px; overflow: hidden; z-index: 0; opacity: 0; top: 5px; left: 100px; background: transparent;">
                                                            <input id="p19acd7g5qnca3pgaq413318ug5_html5"
                                                    ...
                                                    <div class="isL item">
                                                        ...
                                                        <div class="fl">
                                                            ...
                                                            <img class="seccodeimg" height="28" alt=""
                                                                 src="/images/yzm.jpg">
