                    ...
                    <div class="mod-main">
                        <div class="mt">
                            <ul class="extra-l">
                                ...
                                <li class="fore-2"><a class="curr" href="http://i.jd.com/user/userinfo/showImg.html">头像照片</a>
                                </li>
                            ...
                            <div class="update-lcol">
                                <div class="mb10">
                                    <object id="SWFUpload_0" type="application/x-shockwave-flash"
                                            data="/images/swfupload.swf?preventswfcaching=1419921680918" width="202"
                                            height="34" class="swfupload">
                                        <param name="wmode" value="window">
                                        <param name="movie"
                                               value="http://i.jd.com/commons/swfupload.swf?preventswfcaching=1419921680918">
                                        <param name="quality" value="high">
                                        <param name="menu" value="false">
                                        <param name="allowScriptAccess" value="always">
                                        <param name="flashvars"
                                               value="movieName=SWFUpload_0&amp;uploadURL=http%3A%2F%2Fi.jd.com%2Fuser%2Fupload%2Fimage.action&amp;useQueryString=false&amp;requeueOnError=false&amp;httpSuccess=&amp;assumeSuccessTimeout=0&amp;params=flashuploadimg%&amp;filePostName=file&amp;fileTypes=*.jpg%3B*.gif%3B*.png%3B*.jpeg%3B*.bmp&amp;fileTypesDescription=img&amp;fileSizeLimit=4%20MB&amp;fileUploadLimit=0&amp;fileQueueLimit=0&amp;debugEnabled=false&amp;buttonImageURL=/images/perfect_bg.jpg&amp;buttonWidth=202&amp;buttonHeight=34&amp;buttonText=&amp;buttonTextTopPadding=0&amp;buttonTextLeftPadding=0&amp;buttonTextStyle=color%3A%20%23000000%3B%20font-size%3A%2016pt%3B&amp;buttonAction=-100&amp;buttonDisabled=false&amp;buttonCursor=-1">
                                    </object>
                                ...
                                <div class="smc face-list">
                                    <ul class="imgUl">
                                        <li value="1"><img src="/images/defaultImgs/1.jpg" alt="" width="50"
                                                           height="50"><b></b></li>
                                        <li value="2"><img src="/images/defaultImgs/2.jpg" alt="" width="50"
                                                           height="50"><b></b></li>
                                        <li value="3"><img src="/images/defaultImgs/3.jpg" alt="" width="50"
                                                           height="50"><b></b></li>
                                        <li value="4"><img src="/images/defaultImgs/4.jpg" alt="" width="50"
                                                           height="50"><b></b></li>
                                        <li value="5"><img src="/images/defaultImgs/5.jpg" alt="" width="50"
                                                           height="50"><b></b></li>
                                        <li value="6"><img src="/images/defaultImgs/6.jpg" alt="" width="50"
                                                           height="50"><b></b></li>
                                        <li value="7"><img src="/images/defaultImgs/7.jpg" alt="" width="50"
                                                           height="50"><b></b></li>
                                        <li value="8"><img src="/images/defaultImgs/8.jpg" alt="" width="50"
                                                           height="50"><b></b></li>
                                        <li value="9"><img src="/images/defaultImgs/9.jpg" alt="" width="50"
                                                           height="50"><b></b></li>
                                        <li value="10"><img src="/images/defaultImgs/10.jpg" alt="" width="50"
                                                            height="50"><b></b></li>
                                        <li value="11"><img src="/images/defaultImgs/11.jpg" alt="" width="50"
                                                            height="50"><b></b></li>
                                        <li value="12"><img src="/images/defaultImgs/12.jpg" alt="" width="50"
                                                            height="50"><b></b></li>
                                        <li value="13"><img src="/images/defaultImgs/13.jpg" alt="" width="50"
                                                            height="50"><b></b></li>
                                        <li value="14"><img src="/images/defaultImgs/14.jpg" alt="" width="50"
                                                            height="50"><b></b></li>
                                        <li value="15"><img src="/images/defaultImgs/15.jpg" alt="" width="50"
                                                            height="50"><b></b></li>
                                        <li value="16"><img src="/images/defaultImgs/16.jpg" alt="" width="50"
                                                            height="50"><b></b></li>
                                    </ul>
                                    <div class="btns mt20">
                                        <a href="javascript:void(0)" class="btn-5 mr10"
