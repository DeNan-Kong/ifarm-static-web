                            ...
                            <div class="user-set userset-lcol">
                                <div class="form">
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="text" class="itxt" maxlength="20" id="nickName"
                                                   name="userVo.nickName" value="林中守望者">
                                            <div class="clr"></div>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <div>
                                                ...
                                                </strong><a target="_blank" class="ml5 ftx05"
                                                            href="http://safe.jd.com/validate/updateMail">修改</a><span
                                                    class="ftx-03">&nbsp;&nbsp;&nbsp;已验证</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="text" class="itxt" maxlength="20" name="userVo.realName"
                                                   id="realName" value="张志君">
                                            <div class="clr"></div>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            ...
                                            <select name="userVo.city" class="selt mr5" id="city" value="2826">
                                                ...
                                                <option value="2919">崇明县</option>
                                            </select>
                                            <select name="userVo.county" class="selt mr5" id="county" value="2864">
                                                <option value="2864">外环以外</option>
                                            </select>
                                            <div class="clr"></div>
                                            <div class="prompt-06"><span id="city_msg"></span></div>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <span class="label">&nbsp;</span>
                                        <div class="fl">
                                            <input type="text" class="itxt itxt1" name="userVo.address" id="address"
                                                   value="上海徐汇区内环以内漕溪北路737弄2号楼3201室">
                                            <div class="clr"></div>
